...
class DerivatorBlock(CBD):
	...
	"""
	def __init__(self, block_name):
		super().__init__(block_name, input_ports=['IC', 'IN1', 'delta_t'],
						 output_ports=['OUT1'])

		# Create the Blocks
		self.addBlock(ProductBlock("multiply_ic"))
		...
		self.addConnection("IC", "multiply_ic", input_port_name='IN1')
		self.addConnection("IN1", "delay", input_port_name='IN1')
		self.addConnection("IN1", "sum1", input_port_name='IN1')
		self.addConnection("IN1", "sum2", input_port_name='IN1')
		self.addConnection("delta_t", "inverter", input_port_name='IN1')
		self.addConnection("delta_t", "multiply_ic", input_port_name='IN2')
		self.addConnection("sum1", "delay", output_port_name='OUT1',
						   input_port_name='IC')
		self.addConnection("delay", "negator2", output_port_name='OUT1',
						   input_port_name='IN1')
		self.addConnection("multiply_ic", "negator1", output_port_name='OUT1',
						   input_port_name='IN1')
		self.addConnection("negator1", "sum1", output_port_name='OUT1',
						   input_port_name='IN2')
		self.addConnection("negator2", "sum2", output_port_name='OUT1',
						   input_port_name='IN2')
		self.addConnection("multiply", "OUT1", output_port_name='OUT1')
		self.addConnection("inverter", "multiply", output_port_name='OUT1',
						   input_port_name='IN2')
		self.addConnection("sum2", "multiply", output_port_name='OUT1',
						   input_port_name='IN1')
...
class IntegratorBlock(CBD):
	...
	def __init__(self, block_name):
		super().__init__(block_name, input_ports=['IC', 'delta_t', 'IN1'],
						 output_ports=['OUT1'])
		...
		self.addConnection("delta_t", "multiply", input_port_name='IN2')
		self.addConnection("IN1", "delay", input_port_name='IN1')
		self.addConnection("y0", "delay", output_port_name='OUT1',
						   input_port_name='IC')
		self.addConnection("multiply", "sum", output_port_name='OUT1',
						   input_port_name='IN2')
		self.addConnection("delay", "multiply", output_port_name='OUT1',
						   input_port_name='IN1')
		self.addConnection("delayState", "sum", output_port_name='OUT1',
						   input_port_name='IN1')
		self.addConnection("sum", "delayState", output_port_name='OUT1',
						   input_port_name='IN1')
