...
class Network(CoupledDEVS):
    def __init__(self, path: str):
        ...
        self.junctions = {j_data.name: self.addSubModel(Junction(j_data.inputs, j_data.transfer_time)) for j_data in data.junctions}
        ...
        for i in range(len(self.rails)):
            ...
            print(f"connecting {s_port} to {str(self.rails[i].input)}")
